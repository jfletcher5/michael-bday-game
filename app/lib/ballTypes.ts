...
export const BALL_TYPES: BallType[] = [
  ...
  // Generated local sport artwork keeps Michael's requested balls available offline.
  {
    ...
    strokeColor: '#4a2510',
    isDefault: false,
    imageUrl: '/american-football-ball.svg',
    imageCover: true,
    description: 'A classic brown football ready for a touchdown run!',
  },
  {
    id: 'soccer-ball',
    name: 'Soccer Ball',
    ...
    strokeColor: '#111827',
    isDefault: false,
    imageUrl: '/soccer-ball.svg',
    imageCover: true,
    description: 'A black-and-white soccer ball built for goal scoring!',
  },
  {
    id: 'golf-ball',
    name: 'Golf Ball',
    ...
    strokeColor: '#d1d5db',
    isDefault: false,
    imageUrl: '/golf-ball.svg',
    imageCover: true,
    description: 'A dimpled golf ball that rolls straight down the fairway!',
  },
  {
    id: 'baseball',
    name: 'Baseball',
    ...
    strokeColor: '#dc2626',
    isDefault: false,
    imageUrl: '/baseball-ball.svg',
    imageCover: true,
    description: 'A stitched baseball with big-league bounce!',
  },
  {
    id: 'macy',
    name: 'Macy',
